...
const atualizarDisplay = (texto) => {
    ...
    if (novoNumero) {
        ...
        display.textContent += texto.toLocaleString('BR'); //se eu não colocar o +, os numeros não serão concatenados
...
const ativarIgual = () => {
    ...
    operador = undefined; //se eu clicar em algum operador, não vai fazer uma nova conta
